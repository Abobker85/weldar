...
@section('content')
    ...
    <body>
        <div class="form-container">
            <form id="certificate-form" action="{{ route('fcaw-certificates.store') }}" method="POST"
                ...
                @include('fcaw_certificates.partials.header')
                @include('fcaw_certificates.partials.certificate-details')
                @include('fcaw_certificates.partials.test-description')
                @include('fcaw_certificates.partials.welding-variables')
                @include('fcaw_certificates.partials.position-qualification')

                <!-- Results Section -->
                <div class="section-header-row">
                    <h2 class="section-title">Test Results & Certification</h2>
                </div>
                @include('fcaw_certificates.partials.results-section')
