...
<table class="variables-table">
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="welding_process" id="welding_process"
                ...
                <option value="FCAW" selected>FCAW</option>
            </select>
        </td>
        <td class="var-range">
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="welding_type">
                <option value="semi-automatic" selected>semi-automatic</option>
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="backing" id="backing" onchange="updateBackingRange(); toggleManualBackingEntry()">
                <option value="With Backing" selected>With Backing</option>
            ...
            <input type="text" class="form-input" name="backing_manual" id="backing_manual"
                ...
                oninput="updateBackingRange()">
        </td>
        <td class="var-range">
            <span id="backing_range_span">With backing</span>
            <input type="hidden" name="backing_range" id="backing_range" value="With backing">
    ...
    <tr>
        <td class="var-label">
            <div class="checkbox-container">
                <input type="checkbox" name="plate_specimen" id="plate_specimen" checked onchange="toggleDiameterField()">
        ...
        <td class="var-range">
            <span id="diameter_range_span">Plate & Pipe</span>
            <input type="hidden" name="diameter_range" id="diameter_range" value="Plate & Pipe">
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="filler_f_no" id="filler_f_no"
                ...
                <option value="F-No.6">F-No.6</option>
    ...
    Process 2 __ 3 layers minimum
            <div class="checkbox-container" style="display: inline-block; margin-left: 10px;">
                <input type="radio" name="process2" id="process2_yes" value="yes">
                <label for="process2_yes">YES</label>
                <input type="radio" name="process2" id="process2_no" value="no" checked>
