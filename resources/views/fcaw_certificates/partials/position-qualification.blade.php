...
<table class="variables-table">
    ...
    <tr>
        <td rowspan="1" class="var-label" style="vertical-align: middle;">Position(s):</td>
        <td class="var-value">
            <div class="form-group">
                ...
                <select class="form-select" name="test_position" id="test_position" required
                    ...
                    @if(isset($testPositions) && is_array($testPositions))
        ...
        <td class="var-range" style="min-height: 100px; vertical-align: top; padding-top: 8px; padding-bottom: 8px;">
            <span id="position_range_span">{{ old('position_range', isset($certificate) ? $certificate->position_range : '') }}</span>
            <input type="hidden" name="position_range" id="position_range" value="{{ old('position_range', isset($certificate) ? $certificate->position_range : '') }}">
        </td>
    </tr>
   <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="vertical_progression" id="vertical_progression" onchange="updateVerticalProgressionRange()">
                ...
                <option value="Uphill" {{ in_array(old('vertical_progression', isset($certificate) ? $certificate->vertical_progression : ''), ['Uphill', 'Upward']) ? 'selected' : '' }}>Uphill</option>
                <option value="Downhill" {{ in_array(old('vertical_progression', isset($certificate) ? $certificate->vertical_progression : ''), ['Downhill', 'Downward']) ? 'selected' : '' }}>Downhill</option>
            </select>
        </td>
        <td class="var-range">
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="backing_gas" id="backing_gas" onchange="updateBackingGasRange()">
                ...
                <option value="With backing Gas" {{ old('backing_gas', isset($certificate) ? $certificate->backing_gas : 'With backing Gas') == 'With backing Gas' ? 'selected' : '' }}>With backing Gas</option>
    ...
    <tr>
        ...
        <td class="var-value">
            <span>....</span>
            <input type="hidden" name="oscillation_value" id="oscillation_value" value="{{ old('oscillation_value', isset($certificate) ? $certificate->oscillation_value : '....') }}">
        </td>
        <td class="var-range">
            <span>....</span>
    ...
    <tr>
        ...
        <td class="var-value">
            <span>....</span>
            <input type="hidden" name="operation_mode" id="operation_mode" value="{{ old('operation_mode', isset($certificate) ? $certificate->operation_mode : '....') }}">
        </td>
        <td class="var-range">
            <span>....</span>
