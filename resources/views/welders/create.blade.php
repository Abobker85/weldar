...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Welder</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('welders.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('passport_id_no') is-invalid @enderror" id="passport_id_no" name="passport_id_no" value="{{ old('passport_id_no') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('welder_no') is-invalid @enderror" id="welder_no" name="welder_no" value="{{ old('welder_no') }}">
                ...
                <div class="row">                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select select2 @error('nationality') is-invalid @enderror" id="nationality" name="nationality" required>
                                ...
                                @foreach($nationalities as $key => $value)
                                    <option value="{{ $key }}" {{ old('nationality') == $key ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                            @error('nationality')
                                <div class="invalid-feedback">{{ $message }}</div>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="form-text">Upload a photo of the welder (JPEG, PNG, JPG, max 2MB)</div>
                    @error('photo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <label for="rt_report" class="form-label">RT Report (PDF) <span class="text-danger">*</span></label>
                    <input type="file" class="form-control @error('rt_report') is-invalid @enderror" id="rt_report" name="rt_report" accept="application/pdf" required>
                    <div class="form-text">Upload the RT Report as a PDF file (max 5MB)</div>
                    @error('rt_report')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('rt_report_serial') is-invalid @enderror" id="rt_report_serial" name="rt_report_serial" value="{{ old('rt_report_serial') }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('ut_report_serial') is-invalid @enderror" id="ut_report_serial" name="ut_report_serial" value="{{ old('ut_report_serial') }}">
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary">Create Welder</button>
                </div>
            </form>
        </div>
    </div>
