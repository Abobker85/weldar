...
<table style="width: 100%; table-layout: fixed; margin: 0; border-collapse: collapse; border-top: 1px solid #000;">
    ...
    <tr>
        ...
        <td class="var-value" style="border: 1px solid #000; padding: 5px;">
            <input type="text" class="form-input" name="inspector_name" id="inspector_name" value="{{ isset($certificate) ? ($certificate->inspector_name ?? 'Ibrahim Abdullah') : 'Ibrahim Abdullah' }}" style="width: 100%">
        </td>
