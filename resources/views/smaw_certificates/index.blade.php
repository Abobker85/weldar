        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>SMAW Welder Qualification Certificates</div>
                    <div>
                        <a href="{{ route('smaw-certificates.create') }}" class="btn btn-sm btn-primary">
                            <i class="fas fa-plus"></i> New SMAW Certificate
                        </a>
                    </div>
                </div>
...
<script>
    $(function() {
        var table = $('#certificates-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('smaw-certificates.index') }}",
                data: function(d) {
