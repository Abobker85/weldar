    ...
    <div class="form-container">
        ...
        <table class="variables-table">
            ...
            <tr>
                ...
                <td class="var-value">
                        GTAW (Root/Hot) + SMAW (Filling/Cap)
                </td>
                <td class="var-range">GTAW or SMAW</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="var-range">{{ $certificate->p_number_range_manual ?? $certificate->p_number_range }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="var-value">
                    @if($certificate->filler_product_form == '__manual__')
                        {{ $certificate->filler_product_form_manual }}
                    @else
                        {{ $certificate->filler_product_form }}
                    @endif
                </td>
                <td class="var-range">
                    @if($certificate->filler_product_form_range == '__manual__')
                        {{ $certificate->filler_product_form_range_manual }}
                    @else
                        {{ $certificate->filler_product_form_range }}
                    @endif
                </td>
            </tr>
            <tr>
                ...
                <td class="var-value">GTAW({{ $certificate->gtaw_deposit_thickness }} mm) 

                    SMAW({{ $certificate->smaw_deposit_thickness }} mm)
                </td>

                <td class="var-range">GTAW({{ $certificate->gtaw_deposit_thickness_range }} mm) 
                    SMAW({{ $certificate->smaw_deposit_thickness_range }} mm)
                </td>
            </tr>
            <tr>
                <td class="var-label">
                    ...
                    <div style="display: inline-block; margin-left: 10px;">
                        ...
                        YES
                        <span style="display: inline-block; width: 14px; height: 14px; border: 1px solid #000; margin: 0 5px 0 10px; text-align: center; line-height: 12px;">
                            {!! $certificate->gtaw_process == 0 ? '✓' : '&nbsp;' !!}
                        </span>
                        NO
                    </div>
                </td>
                <td class="var-value">GTAW({{ $certificate->gtaw_thickness }}mm)</td>
                <td class="var-range">GTAW({{ $certificate->gtaw_thickness_range }})</td>
            </tr>
             <tr>
                <td class="var-label">
