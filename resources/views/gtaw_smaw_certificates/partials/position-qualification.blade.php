    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="backing_gas" id="backing_gas" onchange="updateBackingGasRange()">
                ...
                <option  value="With backing Gas For GTAW">With backing Gas For GTAW</option>
                <option value="Without backing Gas For GTAW">Without backing Gas For GTAW</option>
            </select>
        </td>
        <td class="var-range">
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="gtaw_polarity" id="gtaw_polarity" onchange="updateGtawPolarityRange()">
                <option value="" selected disabled>Select</option>
                <option selected value="AC For GTAW">AC For GTAW</option>
                <option value="DCEN For GTAW">DCEN For GTAW</option>
            </select>
        </td>
        <td class="var-range">
            <span id="gtaw_polarity_range_span">...</span>
            <input type="hidden" name="gtaw_polarity_range" id="gtaw_polarity_range" value="">
        </td>
    </tr>
    <tr>
