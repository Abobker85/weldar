...
<table class="variables-table">
    ...
    <tr>
        ...
        <td class="var-value">
            <select class="form-select" name="welding_process" id="welding_process"
                ...
                <option value="SAW" {{ old('welding_process', $certificate->welding_process) == 'SAW' ? 'selected' : '' }}>SAW</option>
            </select>
        </td>
        <td class="var-range">
            <span id="process_range_span">SAW</span>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="var-label">Voltage Range:</td>
        <td class="var-value">
            <input type="text" class="form-input" name="voltage_range"
                placeholder="Enter voltage range" value="{{ old('voltage_range', $certificate->voltage_range) }}">
        </td>
        <td class="var-range">
            <input type="text" class="form-input" name="voltage_range_range"
                placeholder="Enter qualified range" value="{{ old('voltage_range_range', $certificate->voltage_range_range) }}">
        </td>
    </tr>
    <tr>
        <td class="var-label">Amperage Range:</td>
        <td class="var-value">
            <input type="text" class="form-input" name="amperage_range"
                placeholder="Enter amperage range" value="{{ old('amperage_range', $certificate->amperage_range) }}">
        </td>
        <td class="var-range">
            <input type="text" class="form-input" name="amperage_range_range"
                placeholder="Enter qualified range" value="{{ old('amperage_range_range', $certificate->amperage_range_range) }}">
        </td>
    </tr>
    <tr>
        <td class="var-label">Wire Feed Speed:</td>
        <td class="var-value">
            <input type="text" class="form-input" name="wire_feed_speed"
                placeholder="Enter wire feed speed" value="{{ old('wire_feed_speed', $certificate->wire_feed_speed) }}">
        </td>
        <td class="var-range">
            <input type="text" class="form-input" name="wire_feed_speed_range"
                placeholder="Enter qualified range" value="{{ old('wire_feed_speed_range', $certificate->wire_feed_speed_range) }}">
        </td>
    </tr>
    <tr>
        <td class="var-label">Travel Speed:</td>
        <td class="var-value">
            <input type="text" class="form-input" name="travel_speed"
                placeholder="Enter travel speed" value="{{ old('travel_speed', $certificate->travel_speed) }}">
        </td>
        <td class="var-range">
            <input type="text" class="form-input" name="travel_speed_range"
                placeholder="Enter qualified range" value="{{ old('travel_speed_range', $certificate->travel_speed_range) }}">
        </td>
    </tr>
    <tr>
        <td class="var-label">Gas Flow Rate:</td>
        <td class="var-value">
            <input type="text" class="form-input" name="gas_flow_rate"
                placeholder="Enter gas flow rate" value="{{ old('gas_flow_rate', $certificate->gas_flow_rate) }}">
        </td>
        <td class="var-range">
            <input type="text" class="form-input" name="gas_flow_rate_range"
                placeholder="Enter qualified range" value="{{ old('gas_flow_rate_range', $certificate->gas_flow_rate_range) }}">
        </td>
    </tr>
    <tr>
        <td class="var-label">Preheat/Interpass Temp:</td>
        <td class="var-value">
            <input type="text" class="form-input" name="preheat_interpass_temp"
                placeholder="Enter preheat/interpass temp" value="{{ old('preheat_interpass_temp', $certificate->preheat_interpass_temp) }}">
        </td>
        <td class="var-range">
            <input type="text" class="form-input" name="preheat_interpass_temp_range"
                placeholder="Enter qualified range" value="{{ old('preheat_interpass_temp_range', $certificate->preheat_interpass_temp_range) }}">
        </td>
    </tr>
</table>
