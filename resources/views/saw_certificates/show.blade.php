        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>SAW Welder Qualification Certificate Details</div>
                    <div>
                        <a href="{{ route('saw-certificates.certificate', $certificate->id) }}" class="btn btn-sm btn-primary" target="_blank">
                            <i class="fas fa-print"></i> Print Certificate
                        </a>
                        <a href="{{ route('saw-certificates.card', $certificate->id) }}" class="btn btn-sm btn-success" target="_blank">
                            <i class="fas fa-id-card"></i> Print Card
                        </a>
                        <a href="{{ route('saw-certificates.back-card', $certificate->id) }}" class="btn btn-sm btn-info" target="_blank">
                            <i class="fas fa-id-card-alt"></i> Print Back Card
                        </a>
                        <a href="{{ route('saw-certificates.edit', $certificate->id) }}" class="btn btn-sm btn-warning">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="{{ route('saw-certificates.index') }}" class="btn btn-sm btn-secondary">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#rt-report-modal" data-certificate-id="{{ $certificate->id }}" data-welder-id="{{ $certificate->welder_id }}" data-certificate-type="saw">
