...
<head>
    ...
    <title>GTAW Welder Certificate Verification</title>
    ...
    <div class="container">
        <div class="verification-container">
            ...
            <div class="form-title">
                <h2>GTAW Certificate Verification</h2>
                <p class="text-muted">Verify the authenticity of a GTAW welder qualification certificate</p>
            </div>
            ...
            <form class="verification-form" method="POST" action="{{ route('gtaw-certificates.verify-by-certificate-no') }}">
                @csrf
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="certificate_no" name="certificate_no" 
                               ...
                               placeholder="Enter certificate number (e.g. EEA-AIC-GTAW-0001)" required>
