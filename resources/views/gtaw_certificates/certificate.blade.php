    ...
    <div class="form-container">
        ...
        <table class="variables-table">
            ...
            <tr>
                ...
                <td class="var-value">GTAW</td>
                <td class="var-range">GTAW</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="var-value">GTAW({{ $certificate->deposit_thickness }} mm)</td>
                <td class="var-range">GTAW({{ $certificate->deposit_thickness_range }} mm)</td>
            </tr>
            <tr>
                <td class="var-label">
